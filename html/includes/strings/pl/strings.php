...
$l["str_primary_mx_expl_with_sample_x"] = "Rekordy MX wskazują, jakie <i>serwery poczty</i> obsługują pocztę dla <i>nazwa</i>. <i>Nazwa</i> to albo nazwa domeny (z końcową kropką), albo równoważny jej znak '@', albo nazwa jednego komputera czy poddomeny, dla której chcemy zrobić oddzielny <i>serwer poczty</i>. <br>Jako serwer poczty musisz użyć <b>nazwy bezwzględnej</b> komputera, razem z <b>końcową kropką</b> (np. <i>mail.%s.</i>), <b>nie</b> adres IP.";
