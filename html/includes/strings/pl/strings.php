...
$l["str_primary_a_record_expl"] = "Jeśli chcesz dodać rekord A <b>dla samej strefy</b>, użyj bezwzględnej nazwy <b>z kropką na końcu</b> lub znak '@' (at).<br>Jeśli chcesz zrobić mapowanie jednej nazwy na <b>kilka podawanych na zmianę</b>adresów IP (aka Round Robin), to po prostu wpisz różne rekordy A z taką samą nazwą, a innymi adresami IP.<br>Jeśli chcesz ustawić rekord wieloznaczny (wildcard, '*'), to utwórz jakiś rekord A (np. www) i ustaw na niego CNAME wieloznaczny.";
...
$l["str_primary_mx_expl_with_sample_x"] = "Rekordy MX to <b>nazwy</b> (nie adresy IP). Musisz użyć <b>nazwy bezwzględnej</b> komputera, razem z <b>końcową kropką</b> (np: mail.%s.).<br><i>Nazwa</i> to albo nazwa domeny (z końcową kropką), albo, równoważnie, znak '@', albo nazwa jednego komputera czy domeny, dla której chcemy zrobić oddzielny serwer pocztowy.";
